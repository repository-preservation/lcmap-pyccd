...
cpdef np.float_t calc_rmse(np.ndarray[np.float_t, ndim=1] residuals):
    """
...
cpdef np.ndarray[np.float_t, ndim=1] calc_residuals(np.ndarray[np.float_t, ndim=1] actual,
