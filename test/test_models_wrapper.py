...
"""
# test_models is a cythonized wrapper module for accessing cdef'd functions in
# pure python modules. such as here for pytest
...
def test_lasso_coefficient_matrix():
    ...
    dates = np.asarray(read_data(sample)[0], dtype=np.long)
